...
<body>
  ...
  <?php
  $mahasiswa = [
    $mhs1 = new Mahasiswa('00001', 'Ranti', 'SI', '2020', 3.66),
    $mhs2 = new Mahasiswa('00002', 'Rano', 'SI', '2022', 3.85),
    $mhs3 = new Mahasiswa('00003', 'septi', 'SI', '2011', 3.5),
    $mhs4 = new Mahasiswa('00004', 'sinta', 'SI', '2021', 3.6),
  ];
  ?>
